...
import {
  impersonationMinHSvh,
  impersonationHSvh,
  impersonationSidebarFixed,
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <div className="flex items-center w-full">
      ...
      >
        {t("nav.backToWebsites") || "Back to Websites"}
      </Button>
    </div>
  )
})
