        ...
        <div className="self-stretch py-6 border-b border-zinc-800 flex flex-col justify-start items-center gap-6">
          <div className="self-stretch flex flex-col justify-start items-start gap-3">
            ...
            <div className="inline-flex justify-start items-center gap-3">
              <a href="https://www.facebook.com/haycWebsites" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity">
                <img src="https://res.cloudinary.com/dem12vqtl/image/upload/public/images/facebook_icon.svg" alt={t("footer.social.facebookAlt")} className="w-5 h-5" />
              </a>
              <a href="https://www.instagram.com/hayc_websites/" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity">
                <img src="https://res.cloudinary.com/dem12vqtl/image/upload/public/images/insta_icon.svg" alt={t("footer.social.instagramAlt")} className="w-5 h-5" />
              </a>
            </div>
          </div>
          <div className="self-stretch flex flex-col justify-start items-start gap-3">
          ...
          <div className="self-stretch flex flex-col justify-start items-start gap-3">
            ...
            <div className="self-stretch inline-flex justify-start items-center gap-2">
              <img src="https://res.cloudinary.com/dem12vqtl/image/upload/public/images/mail_icon.svg" alt={t("footer.emailAlt")} className="w-5 h-5" />
