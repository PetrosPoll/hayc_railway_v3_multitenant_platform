...
const TESTIMONIALS: Testimonial[] = [
  ...
  {
    nameKey: "home.testimonialsSection.items.4.name",
    titleKey: "home.testimonialsSection.items.4.title",
    rating: 5,
    textKey: "home.testimonialsSection.items.4.text",
    avatar: null,
    projectUrl: "#",
  },
  {
    nameKey: "home.testimonialsSection.items.5.name",
    titleKey: "home.testimonialsSection.items.5.title",
    rating: 5,
    textKey: "home.testimonialsSection.items.5.text",
    avatar: null,
    projectUrl: "#",
  },
];
...
function StarRating({ rating, fullStarAlt, halfStarAlt }: { rating: number; fullStarAlt: string; halfStarAlt: string }) {
  ...
  for (let i = 1; i <= 5; i++) {
    if (i <= Math.floor(rating)) {
      stars.push(<img key={i} src="https://res.cloudinary.com/dem12vqtl/image/upload/public/images/testimonials_full_star.svg" alt={fullStarAlt} className="w-4 h-4" />);
    } else if (i === Math.ceil(rating) && rating % 1 >= 0.4) {
      stars.push(<img key={i} src="https://res.cloudinary.com/dem12vqtl/image/upload/public/images/testimonials_half_star.svg" alt={halfStarAlt} className="w-4 h-4" />);
    }
  }
    ...
    <section className={cn("w-full px-4 md:px-16 py-12 md:py-24 bg-black", className)}>
      <div className="w-full max-w-7xl mx-auto flex flex-col md:flex-row justify-start md:justify-between items-start gap-12">
        ...
        <div className="w-full md:w-[572px] flex flex-col gap-3">
          <div className="w-full p-6 bg-[#404040]/20 rounded-[20px] outline outline-1 outline-zinc-800 flex justify-between items-start">
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-2">
                <img src="https://res.cloudinary.com/dem12vqtl/image/upload/public/images/testimonials_facebook.svg" alt={t("home.testimonialsSection.platforms.facebook.alt")} className="w-4 h-4" />
            ...
            <img src="https://res.cloudinary.com/dem12vqtl/image/upload/public/images/testimonials_export.svg" alt={t("home.testimonialsSection.platforms.common.externalLinkAlt")} className="w-6 h-6 opacity-80" />
          </div>

          <div className="w-full p-6 bg-[#404040]/20 rounded-[20px] outline outline-1 outline-zinc-800 flex justify-between items-start">
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-2">
                <img src="https://res.cloudinary.com/dem12vqtl/image/upload/public/images/testimonials_trustpilot.svg" alt={t("home.testimonialsSection.platforms.trustpilot.alt")} className="w-4 h-4" />
        ...
        <div className="flex items-center gap-12 self-end">
          ...
          >
            <img src="https://res.cloudinary.com/dem12vqtl/image/upload/public/images/testimonials_orange_arrow.svg" alt={t("home.testimonialsSection.previousAlt")} className="w-11 h-9 rotate-180" />
          </button>
          <button
            type="button"
            className="hover:opacity-70 transition-opacity"
            onClick={() => navigateDeck(1)}
          >
            <img src="https://res.cloudinary.com/dem12vqtl/image/upload/public/images/testimonials_orange_arrow.svg" alt={t("home.testimonialsSection.nextAlt")} className="w-11 h-9" />
          </button>
        </div>
        </div>
      </div>
