...
import { ArrowLeft, Mail, MousePointerClick, Eye, TrendingUp, Calendar, Send, CheckCircle, XCircle, AlertCircle, Tag as TagIcon, RefreshCw, HelpCircle } from "lucide-react";

export default function CampaignAnalytics() {
  const { websiteId, campaignId } = useParams();
  const navigate = useNavigate();
  const { t } = useTranslation();

  const { data, isLoading, isFetching, refetch } = useQuery({
    queryKey: [`/api/newsletter/campaigns/${campaignId}/analytics`, websiteId],
    queryFn: async () => {
  ...
  const { data: tags = [] } = useQuery<any[]>({
    queryKey: [`/api/tags?websiteProgressId=${websiteId}`],
    enabled: !!websiteId,
  });
  ...
  return (
    <TooltipProvider>
      <div className="container mx-auto py-8 px-4">
        <Button
          variant="ghost"
          onClick={() => navigate(`/dashboard/website/${websiteId}?tab=newsletter&view=campaigns`)}
          className="mb-6"
                  ...
                  <CardTitle className="text-sm font-medium text-gray-600 flex items-center gap-1">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent className="max-w-xs">
                        <p>{t('newsletter.analyticsTooltips.sent')}</p>
                      </TooltipContent>
                    </Tooltip>
                  </CardTitle>
                </CardHeader>
                ...
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium text-gray-600 flex items-center gap-1">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent className="max-w-xs">
                        <p>{t('newsletter.analyticsTooltips.delivered')}</p>
                      </TooltipContent>
                    </Tooltip>
                  </CardTitle>
                </CardHeader>
                ...
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium text-gray-600 flex items-center gap-1">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent className="max-w-xs">
                        <p>{t('newsletter.analyticsTooltips.bounces')}</p>
                      </TooltipContent>
                    </Tooltip>
                  </CardTitle>
                </CardHeader>
                ...
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium text-gray-600 flex items-center gap-1">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent className="max-w-xs">
                        <p>{t('newsletter.analyticsTooltips.complaints')}</p>
                      </TooltipContent>
                    </Tooltip>
                  </CardTitle>
                </CardHeader>
                ...
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium text-gray-600 flex items-center gap-1">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent className="max-w-xs">
                        <p>{t('newsletter.analyticsTooltips.opens')}</p>
                      </TooltipContent>
                    </Tooltip>
                  </CardTitle>
                </CardHeader>
                ...
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium text-gray-600 flex items-center gap-1">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent className="max-w-xs">
                        <p>{t('newsletter.analyticsTooltips.clicks')}</p>
                      </TooltipContent>
                    </Tooltip>
                  </CardTitle>
                </CardHeader>
                ...
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium text-gray-600 flex items-center gap-1">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent className="max-w-xs">
                        <p>{t('newsletter.analyticsTooltips.clickThroughRate')}</p>
                      </TooltipContent>
                    </Tooltip>
                  </CardTitle>
                </CardHeader>
