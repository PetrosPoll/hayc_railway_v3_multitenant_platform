...
import {
  ...
  landingSectionClass,
  landingCardClass,
  landingReviewCardClass,
  landingFormLabelClass,
  landingInputClass,
          ...
          <div className="flex flex-col items-center gap-4 md:flex-row md:items-start md:justify-between md:gap-8 mb-12">
            ...
            <div className="flex items-center justify-between w-full md:w-auto md:flex-shrink-0">
              ...
              <div className="flex gap-2 md:hidden">
                <button
                  ...
                  className={landingLangButtonClass(i18n.language === "en")}
                >
                  🇬🇧
                </button>
                <button
                  ...
                  className={landingLangButtonClass(i18n.language === "gr")}
                >
                  🇬🇷
                </button>
              </div>
            ...
            <div className="text-center flex-1">
              <h1 className="text-2xl md:text-4xl font-bold text-white font-brand mb-4">
                Over the past years, we’ve built and managed 110+ professional websites for businesses selling online services.
               
              </h1>
              <p className="text-lg md:text-xl text-white/70 font-brand max-w-2xl mx-auto">
                We’ve condensed everything we’ve learned into a simple monthly website system —
                designed to help you launch faster, reduce friction, and grow with confidence.
              </p>
            </div>
              ...
              <div className="w-full">
                ...
                {!showCalendly ? (
                  <Card className={landingCardClass}>
                    <CardHeader>
                      <CardTitle className="text-center text-white font-brand">Enter your details to schedule a free consultation</CardTitle>
                  ...
                  <Card className={landingCardClass}>
                    <CardHeader>
                      <CardTitle className="text-center text-green-500 flex items-center justify-center gap-2 font-brand">
 ...
 */}
      ...
      <section className={landingSectionClass}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className={landingSectionTitleClass}>{t('landingPage.benefits.title')}</h2>
            <p className={landingSectionSubtitleClass}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {benefits.map((benefit, index) => (
              <div key={index} className="text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-[#ED4C14]/15 text-[#ED4C14] rounded-full mb-6">
                  {benefit.icon}
                </div>
                <h3 className="text-xl font-bold mb-4 text-white font-brand">{benefit.title}</h3>
                <p className="text-white/70 font-brand">{benefit.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className={landingSectionClass}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className={landingSectionTitleClass}>{t('landingPage.reviews.title')}</h2>
            <p className={landingSectionSubtitleClass}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {/* Review 1 */}
            <Card className={landingReviewCardClass}>
              <CardContent className="p-6 flex flex-col h-full">
                ...
                <blockquote className="text-white/80 mb-4 flex-grow text-sm leading-relaxed font-brand">
                  "{t('landingPage.reviews.review1.text')}"
                </blockquote>
                <div className="mt-auto">
                  <p className="font-semibold text-white font-brand">{t('landingPage.reviews.review1.author')}</p>
                  <p className="text-sm text-white/60 font-brand">{t('landingPage.reviews.review1.role')}</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className={landingReviewCardClass}>
              <CardContent className="p-6 flex flex-col h-full">
                ...
                <div className="mt-auto">
                  <p className="font-semibold text-white font-brand">{t('landingPage.reviews.review2.author')}</p>
                  <p className="text-sm text-white/60 font-brand">{t('landingPage.reviews.review2.role')}</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className={landingReviewCardClass}>
              <CardContent className="p-6 flex flex-col h-full">
                ...
                <div className="mt-auto">
                  <p className="font-semibold text-white font-brand">{t('landingPage.reviews.review3.author')}</p>
                  <p className="text-sm text-white/60 font-brand">{t('landingPage.reviews.review3.role')}</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className={landingReviewCardClass}>
              <CardContent className="p-6 flex flex-col h-full">
                ...
                <div className="mt-auto">
                  <p className="font-semibold text-white font-brand">{t('landingPage.reviews.review4.author')}</p>
                  <p className="text-sm text-white/60 font-brand">{t('landingPage.reviews.review4.role')}</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className={landingReviewCardClass}>
              <CardContent className="p-6 flex flex-col h-full">
                ...
                <div className="mt-auto">
                  <p className="font-semibold text-white font-brand">{t('landingPage.reviews.review5.author')}</p>
                  <p className="text-sm text-white/60 font-brand">{t('landingPage.reviews.review5.role')}</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className={landingReviewCardClass}>
              <CardContent className="p-6 flex flex-col h-full">
                ...
                <div className="mt-auto">
                  <p className="font-semibold text-white font-brand">{t('landingPage.reviews.review6.author')}</p>
                  <p className="text-sm text-white/60 font-brand">{t('landingPage.reviews.review6.role')}</p>
                </div>
              </CardContent>
            </Card>
          </div>
      ...
      <section className={landingSectionClass}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className={landingSectionTitleClass}>{t('landingPage.howItWorks.title')}</h2>
            <p className={landingSectionSubtitleClass}>
            ...
            <div className="space-y-12">
              {howItWorksSteps.map((step, index) => (
                <div key={index} className="flex items-start gap-8">
                  <div className="flex-shrink-0">
                    <div className="w-16 h-16 bg-[#ED4C14] text-white rounded-full flex items-center justify-center text-xl font-bold font-brand">
                      {step.step}
                    </div>
                  </div>
                  <div className="flex-1 pt-2">
                    <h3 className="text-xl font-bold mb-2 text-white font-brand">{step.title}</h3>
                    <p className="text-white/70 font-brand">{step.description}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className={`${landingSectionClass} text-white`}>
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-6 font-brand">
              <span className="text-[#ED4C14]">{t('landingPage.cta1.title')}</span>
            </h2>
            <p className="text-xl mb-8 text-white/80 font-brand">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              <h2 className={landingSectionTitleClass}>{t('landingPage.qualification.title')}</h2>
              <p className={landingSectionSubtitleClass}>
                ...
                <div className="space-y-6">
                  {qualificationQuestions.map((question, index) => (
                    <div key={index} className="flex items-start gap-4">
                      <div className="flex-shrink-0 w-8 h-8 bg-[#ED4C14]/15 text-[#ED4C14] rounded-full flex items-center justify-center text-sm font-bold font-brand">
                        {index + 1}
                      </div>
                      <p className="text-lg font-medium text-white/90 pt-1 font-brand">{question}</p>
                    </div>
                  ))}
                </div>
                
                <div className={`mt-8 p-6 ${landingPanelClass}`}>
                  <h3 className="font-bold text-lg mb-2 text-white font-brand">{t('landingPage.qualification.resultTitle')}</h3>
                  <p className="text-white/70 mb-4 font-brand">
                    {t('landingPage.qualification.resultDescription')}
                  </p>
                  <Button 
                    onClick={scrollToForm}
                    className="bg-[#ED4C14] hover:bg-[#ED4C14]/90 text-[#EFF6FF] font-semibold font-brand"
                  >
      ...
      <section className={landingSectionClass}>
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className={`${landingSectionTitleClass} text-center mb-12`}>{t('landingPage.faq.title')}</h2>
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.map((faq, index) => (
                <AccordionItem key={index} value={`faq-${index}`} className={`border border-zinc-800 rounded-lg px-6 ${landingPanelClass}`}>
                  <AccordionTrigger className="text-left hover:no-underline text-white font-brand [&>svg]:text-white">
                    <span className="font-semibold">{faq.question}</span>
                  </AccordionTrigger>
                  <AccordionContent className="text-white/70 pb-6 font-brand">
                    {faq.answer}
                  </AccordionContent>
                </AccordionItem>
              ))}
      ...
      <section className={`${landingSectionClass} text-white`}>
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-6 font-brand">
              <span className="text-[#ED4C14]">{t('landingPage.final.title')}</span>
            </h2>
            <p className="text-xl mb-8 text-white/80 font-brand">
              {t('landingPage.final.subtitle')}
            </p>
            
            <div className={`p-6 mb-8 ${landingPanelClass}`}>
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div>
                  <div className="text-3xl font-bold text-[#ED4C14] font-brand">{t('landingPage.final.stat1.value')}</div>
                  <div className="text-white/80 font-brand">{t('landingPage.final.stat1.label')}</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-[#ED4C14] font-brand">{t('landingPage.final.stat2.value')}</div>
                  <div className="text-white/80 font-brand">{t('landingPage.final.stat2.label')}</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-[#ED4C14] font-brand">{t('landingPage.final.stat3.value')}</div>
                  <div className="text-white/80 font-brand">{t('landingPage.final.stat3.label')}</div>
                </div>
              </div>
            </div>
            ...
            <Button 
              onClick={scrollToForm}
              size="lg"
              className="bg-[#ED4C14] hover:bg-[#ED4C14]/90 text-[#EFF6FF] px-6 md:px-12 py-4 text-lg md:text-xl font-semibold max-w-full font-brand"
            >
              {t('landingPage.final.button')}
              <ChevronUp className="ml-2 h-5 w-5" />
            </Button>
            
            <p className="mt-4 text-white/60 font-brand">
