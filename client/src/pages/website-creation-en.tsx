      ...
      <section className="py-10 bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="container mx-auto px-4">
          ...
          <div className={showCalendly ? "max-w-5xl mx-auto" : "flex justify-center"}>
            ...
            {/* Form Section */}
            <div className={showCalendly ? "w-full" : "order-1 lg:order-2"} id="lead-form">
              <div className={showCalendly ? "w-full" : "mx-auto lg:mx-0"}>
                
                {!showCalendly ? (
                  <Card className="shadow-xl border-0">
                    <CardHeader>
                      <CardTitle className="text-center">Enter your details to schedule a free consultation</CardTitle>
