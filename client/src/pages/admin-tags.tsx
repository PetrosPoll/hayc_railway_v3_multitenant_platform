...
import { Tag as TagIcon, Plus, Edit3, Trash2, Shield, ArrowLeft } from "lucide-react";
...
export default function AdminTags() {
  ...
  // Fetch admin tags (no websiteProgressId needed)
  ...
  const updateTagMutation = useMutation({
    mutationFn: async (data: TagFormData & { id: number }) => {
      return await apiRequest("PUT", `/api/admin/tags/${data.id}`, data);
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/admin/tags"] });
      toast({
  ...
  const deleteTagMutation = useMutation({
    mutationFn: async (tagId: number) => {
      return await apiRequest("DELETE", `/api/admin/tags/${tagId}`);
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/admin/tags"] });
      toast({
  ...
  return (
    <div className="container mx-auto py-8 mt-16">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-semibold">Admin Tags</h1>
      </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription className="mt-2">
                  Organize users with tags. Tags allow flexible categorization - users can have multiple tags.
                </CardDescription>
              </div>
              <Button
                onClick={() => {
            ...
            {tags.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground mb-4">
                  No tags yet. Create your first tag to start organizing users.
                </p>
        ...
        <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Create a new tag to organize users.
              </DialogDescription>
            </DialogHeader>
            <Form {...form}>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} placeholder="e.g., VIP User" data-testid="input-tag-name" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Tag Name *</FormLabel>
                      <FormControl>
                        <Input {...field} placeholder="e.g., VIP User" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
        ...
        <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Are you sure you want to delete this tag? This will remove the tag from all users, but users will not be deleted.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
